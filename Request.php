...
namespace QuantaForge\Http;

use ArrayAccess;
use Closure;
use QuantaForge\Contracts\Support\Arrayable;
use QuantaForge\Session\SymfonySessionDecorator;
...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * Create a new QuantaForge HTTP request from server variables.
     *
     * @return static
     */
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using QuantaForge.
     *
    ...
    /**
     * Create a new request instance from the given QuantaForge request.
     *
     * @param  \QuantaForge\Http\Request  $from
     * @param  \QuantaForge\Http\Request|null  $to
     * @return static
     */
    ...
    /**
     * Create an QuantaForge request from a Symfony instance.
     *
     ...
     * @return void
     */
    public function setQuantaForgeSession($session)
    {
     ...
     * @param  mixed  $default
     * @return \QuantaForge\Routing\Route|object|string|null
     */
